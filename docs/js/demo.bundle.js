...
/* WEBPACK VAR INJECTION */(function(base) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(4), __webpack_require__(11)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require('flickity'), require('flickity-imagesloaded'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.flickity, global.flickityImagesloaded);
    global.index = mod.exports;
  }
})(this, function (exports, _flickity) {
  'use strict';
  ...
  var Slider = function (_base$features$Featur) {
    _inherits(Slider, _base$features$Featur);
...
/* WEBPACK VAR INJECTION */(function(base) {(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory();
	else if(typeof define === 'function' && define.amd)
...
/* WEBPACK VAR INJECTION */(function(base) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(require('gi-feature-object-fit'), require('../src'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.giFeatureObjectFit, global.src);
    global.demo = mod.exports;
  }
})(this, function (_giFeatureObjectFit, _src) {
  'use strict';

  var _giFeatureObjectFit2 = _interopRequireDefault(_giFeatureObjectFit);
  ...
  base.features.add('fit', _giFeatureObjectFit2.default);

  base.features.add('slider', _src2.default, {
    contain: true,
    prevNextButtons: false
  });

  base.features.add('gallery-slider', _src2.default, {
    imagesLoaded: true,
